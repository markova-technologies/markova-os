...
import api, { getGovernanceSummary } from '../api/client'
...
const Governance = () => {
  ...
  useEffect(() => {
    getGovernanceSummary().then(({ data }) => {
      setMetrics({
    ...
    <div className="governance-page">
      ...
      <div className="governance-dashboard">
        <div className="metrics-row">
          ...
          <div className="metric-box">
            <span className="metric-title">Active Agents (Audited)</span>
            <span className="metric-value text-blue-500">{metrics.agents}</span>
          </div>
          <div className="metric-box">
            <span className="metric-title">Active API Keys</span>
            <span className="metric-value text-green-500">{metrics.keys}</span>
          </div>
        </div>
