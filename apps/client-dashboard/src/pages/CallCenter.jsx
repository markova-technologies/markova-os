            ...
            filteredCalls.map(call => (
              ...
              >
                ...
                <div className="ci-meta">
                  <span className={`ci-sentiment sentiment-${call.sentiment || 'neutral'}`}>●</span>
                  ...
                  <div className="dh-badges">
                    {selectedCall.status === 'live' ? (
                      <div className="dh-badge badge-live">
                        <div className="dot" style={{ animation: 'pulseRed 1.5s infinite' }}></div> Live Call • {selectedCall.duration}
                      </div>
                    ) : (
                      <div className="dh-badge badge-completed">
                        Completed • {selectedCall.duration}
                      </div>
                    )}
