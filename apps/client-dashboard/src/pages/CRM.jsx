  ...
  useEffect(() => {
    const fetchLeads = async () => {
      try {
        ...
        // Map backend calls to frontend contact format
        const mappedContacts = res.data.map(lead => ({
          ...
          source: lead.source || 'Call Center',
          role: lead.role || 'Caller',
          score: lead.score || (lead.totalCalls * 10),
          lastContact: lead.lastCall || new Date().toISOString(),
          interest: lead.service_interest || 'General',
